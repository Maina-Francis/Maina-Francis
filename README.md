...
I bridge the gap between complex backend architectures and polished user experiences. Currently building **AI-native SaaS platforms** and optimizing cloud infrastructure.

- 🔭 **Current Focus:** Bootstrapping [Virro](https://francismaina.com) (Private Beta) — An AI platform for the Creator Economy.
- 🏗️ **Architecture:** Next.js 16, Supabase, AWS Serverless, and Event-Driven Systems.
- 🤖 **AI Stack:** OpenAI, Claude, Gemini, N8N, Langfuse, Fal.ai, and RAG Pipelines.
- 🌍 **Location:** Nairobi, Kenya (Open to Global Remote).
...
![Inngest](https://img.shields.io/badge/Inngest-050038?style=for-the-badge&logo=inngest&logoColor=white)
...
![Fal.ai](https://img.shields.io/badge/Fal.ai-7052FF?style=for-the-badge&logo=fal&logoColor=white)
